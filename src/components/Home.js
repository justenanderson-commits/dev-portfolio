...
const Home = ({ homeSummary }) => {
  ...
  return (
    ...
    >
      <h1 className="text-5xl lg:text-7xl text-center pb-5 lg:pb-16">Justen Anderson</h1>
      <h2 className="text-2xl lg:text-4xl text-center text-sky-300">Developer | Educator | Veteran</h2>
