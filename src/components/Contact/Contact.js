...
const Contact = () => {
  return (
    <div className="text-slate-900 text-2xl w-full h-screen h-9/10 bg-white pt-10">
      ...
      <div className="bg-sky-100 mx-auto mt-8 border-slate-900 p-10 border-2 h-2/3 w-2/3 rounded-xl">
        <form className="w-9/10">
          ...
          <Textarea
            size="lg"
            className="w-full h-32 border-slate-900 border-0 mb-2 bg-white"
