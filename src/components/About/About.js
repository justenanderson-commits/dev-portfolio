...
const About = () => {
  return (
    <div className="about text-slate-900 text-2xl w-full min-h-screen h-auto h-9/10 bg-white pt-10">
      <h1 className="about-title text-7xl text-center pb-5">About</h1>
